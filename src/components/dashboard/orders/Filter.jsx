...
const Filter = ({
  ...
  const [filterWithStatus, setFilterWithStatus] = useState(false);
  ...
  const toggleSelect = () => {
    ...
    packageRef.current.classList.remove("show");
  ...
  const togglePackage = () => {
    statusRef.current.classList.remove("show");
    dateRef.current.classList.remove("show");
    packageRef.current.classList.toggle("show");
  };
  const handelActive = (e)=>{
    e.parentElement.classList.add('orangeColor');
    e.addEventListener('blur',()=>{
      e.parentElement.classList.remove('orangeColor')
    })
  }
  return (
    <div className="flex justify-between items-center px-[16px]">
      <div className=" relative h-[56px] w-[640px]  ">
        <svg
      ...
      <div className="select relative">
        ...
        <div className="list" ref={packageRef}>
          <div className="top">
            <h3>{lang === "ar" ? "الباقة" : "Package"}</h3>
            <button
              className="reset"
              onClick={() => {
                setPackage("");
          ...
          <form className="inputs">
            <div className="inp">
              <input
                ...
                id="c1"
                onChange={(e) => {
                  setPackage("باقة استشارة");
                  handelActive(e.target);
                }}
              />
              <label htmlFor="c1"><i className="fa-regular fa-check"></i></label>
              <label htmlFor="c1">باقة استشارة</label>
            </div>
            <div className="inp">
              <input
                type="radio"
                ...
                id="c2"
                onChange={(e) => {
                  setPackage("موعد اسنان");
                  handelActive(e.target);
                }}
              />
              <label htmlFor="c2"><i className="fa-regular fa-check"></i></label>
              <label htmlFor="c2">موعد اسنان</label>
            </div>
            <div className="inp">
              <input
                type="radio"
                ...
                id="c3"
                onChange={(e) => {
                  setPackage("موعد عملية");
                  handelActive(e.target);
                }}
              />
              <label htmlFor="c3"><i className="fa-regular fa-check"></i></label>
              <label htmlFor="c3">موعد عملية</label>
            </div>
          </form>
        </div>
        ...
        <div className="list" ref={statusRef}>
          ...
          <div className="sts">
            <span
              ...
              className="py-[8px] px-[24px] rounded-[16px] bg-secondary8 text-secondary3 font-[500] h-[40px] inline-block"
            >
              {lang === "ar" ? "تم الانتهاء" : "Done"}
            </span>
            <span
              onClick={() => {
                setStatus("active");
